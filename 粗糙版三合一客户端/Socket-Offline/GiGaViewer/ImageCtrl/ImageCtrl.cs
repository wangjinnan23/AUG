...
//        private void UpdateRectShow()
        ...
        public void ImageCtrl_MouseWheel(object sender, MouseEventArgs e)
        {
...
//void UpdateScrollbarInit()
        public void UpdateScrollbarInit()
        {
            if (this.m_scrRectShow.Width <= 0 || this.m_scrRectShow.Height <= 0)
            {
                this.hScrollBarImg.Enabled = false;
    ...
    public class SOCKETcomunication
    {
       ...
       // string host="166.111.65.195"
        ...
        int[] temp2 = new int[8] { 0, 1, 960, 540, 5000, 5960, 1000, 1540 };
      ...
      //      Switch of Online and Offline
        ...
        public void SocketInit1()
        {
            ...
            IPEndPoint IPE = new IPEndPoint(ServerIP, port1);
        ...
        public void SocketInit2()
        {
            ...
            int[] temp2 = new int[8] { 2, 1, 960, 540, 5000, 5960, 1000, 1540 };
            byte[] message2 = new byte[32];
            ...
            Thread.Sleep(10000);
            int[] temp3 = new int[8] { 2, 1, 960, 540, 5000, 5960, 1000, 1540 };
            byte[] message3 = new byte[32];

            for (int i = 0; i < 8; i++)
            {
                (System.BitConverter.GetBytes(temp3[i])).CopyTo(message3, i * 4);
      ...
      //*******   int[] temp = new int[8] { 0, 1, 682, 260, 3550, 9710 ,5430 ,7760 };
       //     int[] temp = new int[8] {0,1,682, 260, 1000,3000,8250,9350 };
        ...
        public Bitmap GetImage1(int frameNum, int ScaleIndex, Rectangle m_showImgRect)
        {
            int[] paramsRelated = { frameNum, ScaleIndex, m_showImgRect.X, m_showImgRect.Y, m_showImgRect.Width, m_showImgRect.Height };
            ...
            int[] temp = new int[8] { 1, 1, m_showImgRect.Width, m_showImgRect.Height, (m_showImgRect.X), (m_RightDownOnImgRated.X), (m_showImgRect.Y), (m_RightDownOnImgRated.Y) };
            Console.WriteLine("This is the LOCATION you send " + m_showImgRect + m_RightDownOnImgRated);
            byte[] message = new byte[32];
            for (int i = 0; i < 8; i++)
            {
